        ...
        if updates:
            for update in updates:
                ...
                if 'document' in message:
                    ...
                    send_messages(chat_id, f"Se generó un cuestionario para los trabajadores de la empresa. Por favor, enviales el siguiente identificador para que puedan acceder al cuestionario: {form_id}")
